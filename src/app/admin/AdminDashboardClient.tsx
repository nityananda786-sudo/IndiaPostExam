    ...
    <main className="min-h-screen bg-slate-50">
      ...
      <section className="mx-auto max-w-7xl px-6 py-10">
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          ...
          >
            <div className="flex h-14 w-14 items-center justify-center rounded-xl bg-indigo-50 text-3xl font-black text-indigo-600">
              MT
            </div>
            ...
            <p className="mt-2 text-sm leading-6 text-slate-500">
              ...
              random question sets and mock-test questions.
            </p>
          ...
          >
            ...
            <p className="mt-2 text-sm leading-6 text-slate-500">
              Control course publication, enrollment and
              aspirant access for phased course rollout.
            </p>

            <div className="mt-5 font-bold text-red-600">
              Manage Publish & Control →
            </div>
          ...
          <Link
            href="/admin/users"
            className="group rounded-2xl border border-slate-200 bg-white p-6 shadow-sm transition hover:-translate-y-1 hover:border-orange-200 hover:shadow-lg"
          >

            <div className="flex h-14 w-14 items-center justify-center rounded-xl bg-orange-50 text-3xl font-black text-orange-600">
              USR
            </div>
            ...
            <p className="mt-2 text-sm leading-6 text-slate-500">
              Manage aspirant accounts, activate or deactivate
              users and view course-wise enrollment summary.
            </p>
