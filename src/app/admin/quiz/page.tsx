      ...
      <section className="bg-[#123f82] text-white">
        <div className="mx-auto max-w-7xl px-6 py-10">
          ...
          <p className="mt-3 max-w-2xl text-white/80">
            Manage books, chapters, topics, questions and 15-question
            practice quiz sets.
          </p>
      ...
      <section className="mx-auto max-w-7xl px-6 py-10">
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          ...
          <AdminCard
            icon="📝"
            title="Quiz Sets"
            description="Create 15-question practice sets from your question bank with randomized questions and options."
            href="/admin/quiz/sets"
            action="Manage Quiz Sets"
          />
          ...
          <AdminCard
            ...
            description="Control which questions and quiz sets are available to aspirants."
            href="/admin/quiz/publish"
            action="Manage Publishing"
          />
