...
export default function QuestionBankPage() {
  ...
  useEffect(() => {
    ...
    const unsubscribe = onSnapshot(
      ...
      (snapshot) => {
        const data: Question[] = snapshot.docs
          .map((item) => ({
            id: item.id,
            ...(item.data() as Omit<
              Question,
  ...
  const addQuestionUrl =
    selectedBookId &&
    selectedChapterId
      ? `/admin/quiz/questions/new?bookId=${encodeURIComponent(
          selectedBookId
        ...
        <div className="mt-8 flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <Link
              ...
              className={`rounded-xl bg-[#123f82] px-5 py-3 text-sm font-bold text-white transition ${
                !selectedChapterId
        ...
        <div className="mt-5">
          ...
          {loadingQuestions ? (
            ...
            <div className="rounded-2xl border border-dashed border-slate-300 bg-white p-12 text-center">
              ...
              <Link
                href={addQuestionUrl}
                className="mt-6 inline-flex rounded-xl bg-[#123f82] px-5 py-3 text-sm font-bold text-white hover:bg-[#0d326a]"
              >
                + Add First Question
              </Link>
